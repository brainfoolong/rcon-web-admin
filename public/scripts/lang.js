...
lang.values.en = {
    ...
    "widgets.update.confirm" : "Warning: Always made a backup before doing this in case of any error. The server will shutdown, install the update, and restart automatically. Be aware that, in case of any errors, you might need to startup your server manually.",
    ...
    "settings.confirm" : "Warning: Always made a backup before doing this in case of any error. The server will shutdown, install the update, and restart automatically. Be aware that, in case of any errors, you might need to startup your server manually.",
